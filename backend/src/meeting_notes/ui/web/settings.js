/* AI Meeting Notes — Settings, Meeting Types, and Shared Utilities */
 ...
 * @param {Object} s - Settings object from Python backend.
 */
...
elBtnBrowseOutput.addEventListener("click", async function () {
  try {
    var dir = await pywebview.api.browse_directory();
