...
a = Analysis(
    ...
    datas=[
        ...
        (str(ui_web / "settings.js"), "meeting_notes/ui/web"),
    ...
    hiddenimports=[
        ...
        "meeting_notes.ui.floating_indicator",
        "meeting_notes.ui.crypto",
        "meeting_notes.ui.merge",
        "meeting_notes.audio.silence",
        "meeting_notes.audio.wav_writer",
